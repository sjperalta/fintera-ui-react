...
function PaymentScheduleModal({ contract, open, onClose, onPaymentSuccess }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center">
      ...
      <AnimatePresence>
        {undoConfirmPaymentId != null && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              onClick={() => setUndoConfirmPaymentId(null)}
              className="absolute inset-0 bg-bgray-900/60 dark:bg-black/80 backdrop-blur-md"
            />
            <motion.div
              initial={{ opacity: 0, scale: 0.9, y: 20 }}
              ...
              <div className="p-8">
                ...
                <div className="flex flex-col sm:flex-row justify-end gap-3 mt-8">
                  ...
                  <button
                    ...
                    disabled={undoLoadingPaymentId === undoConfirmPaymentId}
                  ...
                  >
                    {undoLoadingPaymentId === undoConfirmPaymentId
                      ? t('common.processing')
